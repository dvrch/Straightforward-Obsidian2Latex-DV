...
if ((_DataView && getTag(new _DataView(new ArrayBuffer(1))) != dataViewTag$4) ||
    (_Map && getTag(new _Map) != mapTag$7) ||
    (_Promise && getTag(_Promise.resolve()) != promiseTag) ||
    (_Set && getTag(new _Set) != setTag$7) ||
    (_WeakMap && getTag(new _WeakMap) != weakMapTag$3)) {
  getTag = function(value) {
    ...
    if (ctorString) {
      switch (ctorString) {
        ...
        case mapCtorString: return mapTag$7;
        case promiseCtorString: return promiseTag;
        case setCtorString: return setTag$7;
        case weakMapCtorString: return weakMapTag$3;
      }
    }
    return result;
  };
...
var func$5 = convert_1('groupBy', groupBy_1);
...
var func$3 = convert_1('mapValues', mapValues_1);

func$3.placeholder = placeholder;
var mapValues = func$3;
...
class ArchiveFeature {
    constructor(vault, workspace, parser, dateTreeService, taskTestingService, placeholderService, textReplacementService, metadataService, settings, archiveHeadingPattern = buildHeadingPattern(settings.archiveHeading)) {
        this.vault = vault;
        this.workspace = workspace;
        this.parser = parser;
        this.dateTreeService = dateTreeService;
        ...
        this.taskFilter = {
            blockFilter: (block) => this.taskTestingService.doesTaskNeedArchiving(block.text),
            sectionFilter: (section) => !this.isArchive(section.text),
        };
    }
    archiveShallowTasksInActiveFile(file) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.extractAndArchiveTasksInActiveFile(file, shallowExtractBlocks);
        });
    }
    archiveDeepTasksInActiveFile(file) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.extractAndArchiveTasksInActiveFile(file, deepExtractBlocks);
        });
    }
    archiveTaskUnderCursor(editor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.archiveTasks([{ task: parsedTaskBlock, rule: this.getDefaultRule() }], activeFile);
    ...
    extractAndArchiveTasksInActiveFile(activeFile, extractor) {
        return __awaiter(this, void 0, void 0, function* () {
            const tasks = (yield this.extractTasksFromActiveFile(activeFile, extractor)).map((task) => ({
                task,
                rule: this.settings.rules.find((rule) => rule.statuses.includes(this.getTaskStatus(task))) || this.getDefaultRule(),
            }));
    ...
    archiveTasks(tasks, activeFile) {
        return __awaiter(this, void 0, void 0, function* () {
            yield flow_1(map(({ rule, task }) => ({
                rule,
                task: this.textReplacementService.replaceText(task),
            })), map((taskWithRule) => this.metadataService.appendMetadata(taskWithRule)), map(({ rule, task }) => ({
                task,
                archivePath: rule.archiveToSeparateFile
                    ? this.placeholderService.resolve(rule.defaultArchiveFileName, rule.dateFormat)
                    : "current-file",
            })), groupBy((task) => task.archivePath), mapValues((tasks) => tasks.map(({ task }) => task)), toPairs, map(([archivePath, tasks]) => __awaiter(this, void 0, void 0, function* () {
                const archiveFile = archivePath === "current-file"
                    ? activeFile
                    : yield this.getDiskFile(archivePath); // todo: this may be an issue if the rule says to archive a task to this exact file
    ...
    getDiskFileByPathWithPlaceholders(path) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.getDiskFile(this.placeholderService.resolve(path, this.settings.dateFormat));
        });
    }
    getDiskFile(path) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    archiveBlocksToRoot(tasks, root) {
        ...
        this.dateTreeService.mergeNewBlocksWithDateTree(archiveSection.blockContent, tasks);
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!file) {
                ...
                if (pathContainsFolders) {
                    const folderPath = dropRight_1(pathNodes).join(pathSeparator);
...
class MetadataService {
    ...
    appendMetadata({ task, rule }) {
        ...
        const resolvedMetadata = this.placeholderService.resolve(metadata, dateFormat, task.parentSection.text);
...
class PlaceholderService {
    ...
    getActiveFilePathWithoutExtension() {
        ...
        return (((_b = (_a = this.getActiveFile()) === null || _a === void 0 ? void 0 : _a.path) === null || _b === void 0 ? void 0 : _b.replace(extensionPattern, "")) || "No file open");
    }
    resolve(text, dateFormat, heading) {
        var _a, _b, _c;
        return text
            .replace(PlaceholderService.ACTIVE_FILE_PLACEHOLDER, ((_a = this.getActiveFile()) === null || _a === void 0 ? void 0 : _a.basename) || "No file open")
            .replace(PlaceholderService.ACTIVE_FILE_PLACEHOLDER_NEW, ((_b = this.getActiveFile()) === null || _b === void 0 ? void 0 : _b.basename) || "No file open")
            .replace(PlaceholderService.ACTIVE_FILE_PATH_PLACEHOLDER, this.getActiveFilePathWithoutExtension())
            .replace(PlaceholderService.HEADING_PLACEHOLDER, (heading === null || heading === void 0 ? void 0 : heading.trim()) || ((_c = this.getActiveFile()) === null || _c === void 0 ? void 0 : _c.basename) || "No file open")
            .replace(PlaceholderService.DATE_PLACEHOLDER, window.moment().format(dateFormat));
    }
}
/** @deprecated */
PlaceholderService.ACTIVE_FILE_PLACEHOLDER = "%";
PlaceholderService.ACTIVE_FILE_PLACEHOLDER_NEW = "{{sourceFileName}}";
PlaceholderService.ACTIVE_FILE_PATH_PLACEHOLDER = "{{sourceFilePath}}";
PlaceholderService.DATE_PLACEHOLDER = "{{date}}";
PlaceholderService.HEADING_PLACEHOLDER = "{{heading}}";
...
const _tmpl$$8 = /*#__PURE__*/template(`<a href="https://momentjs.com/docs/#/displaying/format/" target="_blank">format reference</a>`),
  _tmpl$2$4 = /*#__PURE__*/template(`<br>`),
  _tmpl$3$3 = /*#__PURE__*/template(`<b></b>`);
function DateFormatDescription(props) {
  return ["For more syntax, refer to", " ", _tmpl$$8.cloneNode(true), _tmpl$2$4.cloneNode(true), "Your current syntax looks like this:", " ", (() => {
    const _el$3 = _tmpl$3$3.cloneNode(true);
    insert(_el$3, () => window.moment().format(props.dateFormat));
    return _el$3;
  })()];
}

const _tmpl$$7 = /*#__PURE__*/template(`<table></table>`),
  _tmpl$2$3 = /*#__PURE__*/template(`<b></b>`),
...
function PlaceholdersDescription(props) {
  ...
  const sourceFileName = mergedProps.placeholderResolver.resolve("{{sourceFileName}}", defaultFormat);
  const sourceFilePath = mergedProps.placeholderResolver.resolve("{{sourceFilePath}}", defaultFormat);
  return ["Placeholders you can use:", (() => {
    const _el$ = _tmpl$$7.cloneNode(true);
    insert(_el$, createComponent(For, {
      get each() {
        return [["{{date}}", "resolves to the current date in any format"], ["{{sourceFileName}}", ["for the currently open file it resolves to ", (() => {
          const _el$2 = _tmpl$2$3.cloneNode(true);
          insert(_el$2, sourceFileName);
          return _el$2;
        })()]], ["{{sourceFilePath}}", ["for the currently open file it resolves to ", (() => {
...
function SettingsProvider(props) {
  ...
  createEffect(() => __awaiter(this, void 0, void 0, function* () {
    ...
    yield props.plugin.saveSettings();
  }));
...
const _tmpl$$6 = /*#__PURE__*/template(`<div><div class="setting-item-info"><div class="setting-item-name"></div><div class="setting-item-description"></div></div><div class="setting-item-control"></div></div>`);
...
const _tmpl$$5 = /*#__PURE__*/template(`<select class="dropdown"></select>`),
  _tmpl$2$2 = /*#__PURE__*/template(`<option></option>`);
...
const _tmpl$$3 = /*#__PURE__*/template(`<input type="text">`);
...
const _tmpl$$2 = /*#__PURE__*/template(`<ul class="archiver-status-examples"></ul>`),
  _tmpl$2$1 = /*#__PURE__*/template(`<li><code>- [<!>] task</code></li>`),
  _tmpl$3$1 = /*#__PURE__*/template(`<button>Delete rule</button>`),
  _tmpl$4$1 = /*#__PURE__*/template(`<div class="archiver-rule-container"><h2>When</h2><h2>Then</h2></div>`);
...
function Rule(props) {
  ...
  const [destinationFile, setDestinationFile] = createSignal("Another file");
  const [destinationHeading, setDestinationHeading] = createSignal("Under heading");
  ...
  return (() => {
    ...
    insert(_el$7, createComponent(TextSetting, {
      ...
      get description() {
        return createMemo(() => dedupedStatuses().length === 0)() ? "Add some statuses, like '>', '-', '?'" : renderStatusExamples();
      },
      placeholder: "-?>",
      get value() {
    ...
    insert(_el$7, createComponent(DropDownSetting, {
      onInput: ({
        currentTarget: {
          value
        }
      }) => setDestinationFile(value),
      options: ["Another file", "This file"],
      name: "Move it to",
      get value() {
    ...
    insert(_el$7, createComponent(Show, {
      get when() {
        return destinationFile() === "Another file";
      },
      get children() {
    ...
    insert(_el$7, createComponent(DropDownSetting, {
      ...
      }) => setDestinationHeading(value),
      options: ["Under heading", "At the top"],
      get value() {
    ...
    insert(_el$7, createComponent(Show, {
      get when() {
        return destinationHeading() === "Under heading";
      },
      get children() {
...
const _tmpl$$1 = /*#__PURE__*/template(`<div><input type="checkbox" tabindex="0"></div>`);
  ...
  return [createComponent(ToggleSetting, {
    ...
    get children() {
      return [createComponent(TextSetting, {
        ...
        }) => __awaiter(_self$, void 0, void 0, function* () {
...
const _tmpl$ = /*#__PURE__*/template(`<h1>Archiver Settings</h1>`),
  _tmpl$2 = /*#__PURE__*/template(`<h2>Date tree settings</h2>`),
  _tmpl$3 = /*#__PURE__*/template(`<h2>Rules</h2>`),
  _tmpl$4 = /*#__PURE__*/template(`<button>Add rule</button>`),
  _tmpl$5 = /*#__PURE__*/template(`<b></b>`),
  _tmpl$6 = /*#__PURE__*/template(`<code>{{date}}</code>`),
  _tmpl$7 = /*#__PURE__*/template(`<br>`),
  _tmpl$8 = /*#__PURE__*/template(`<code>- [x] water the cat #task </code>`);
function ArchiverSettingsPage(props) {
  const [settings, setSettings] = useSettingsContext();
  const getReplacementResult = () => settings.textReplacement.replacementTest.replace(new RegExp(settings.textReplacement.regex), settings.textReplacement.replacement);
  const _self$ = this;
  return [_tmpl$.cloneNode(true), createComponent(DropDownSetting, {
  ...
  }), createComponent(DropDownSetting, {
    onInput: ({
      currentTarget: {
        value
      }
      ...
      return [createComponent(TextSetting, {
        ...
        get description() {
          return ["Replacement result: ", (() => {
            ...
            insert(_el$5, getReplacementResult);
            return _el$5;
          })()];
        },
        onInput: ({
    ...
    get children() {
      return [createComponent(ToggleSetting, {
        ...
        get name() {
          return [_tmpl$6.cloneNode(true), " format"];
        },
        get description() {
          return createComponent(DateFormatDescription, {
            get dateFormat() {
      ...
      return [createComponent(TextSetting, {
        ...
        get description() {
          return [createComponent(PlaceholdersDescription, {
            ...
            extraPlaceholders: [["{{heading}}", "resolves to the closest heading above the task; when there are none, defaults to file name"]]
          }), _tmpl$7.cloneNode(true), "Current result:", " ", (() => {
            const _el$8 = _tmpl$8.cloneNode(true);
              _el$8.firstChild;
            insert(_el$8, () => props.placeholderService.resolve(settings.additionalMetadataBeforeArchiving.metadata, settings.additionalMetadataBeforeArchiving.dateFormat), null);
            return _el$8;
          })()];
        },
        get value() {
  ...
  }), _tmpl$2.cloneNode(true), createComponent(ToggleSetting, {
    onClick: () => __awaiter(_self$, void 0, void 0, function* () {
    ...
    get children() {
      return createComponent(TextSetting, {
        ...
        get description() {
          return createComponent(DateFormatDescription, {
            get dateFormat() {
              return settings.weeklyNoteFormat;
            }
          });
        },
        get value() {
    ...
    get children() {
      return createComponent(TextSetting, {
        ...
        get description() {
          return createComponent(DateFormatDescription, {
            get dateFormat() {
              return settings.dailyNoteFormat;
            }
          });
        },
        get value() {
...
class ObsidianTaskArchiver extends obsidian.Plugin {
    ...
    initializeDependencies() {
        ...
        this.archiveFeature = new ArchiveFeature(this.app.vault, this.app.workspace, parser, dateTreeService, taskTestingService, placeholderService, textReplacementService, metadataService, this.settings);
