...
% Start obsidian ref: \twemoji\{warning\} warning to users
...
% Start obsidian ref: eq__block_Einstein\\texttt{\expr}
...
% Start obsidian ref: eq__block_1\\texttt{\expr}
...
% Start obsidian ref: figure__block_gradient_steps\\texttt{\fig}
\begin{figure}[htb]
\centering
...
% Start obsidian ref: figure__block_1\\texttt{\fig}
\begin{figure}[htb]
\centering
...
% Start obsidian ref: embedded with sections
...
% Start obsidian ref: table__block_1\\texttt{\table}
%\begin{center}
\begin{table}[ht]
\centering
...
% Start obsidian ref: table__block_2\\texttt{\table}
...
% Start obsidian ref: table__block_long\\texttt{\table}
%\begin{center}
