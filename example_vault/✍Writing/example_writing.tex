\documentclass{doc_class_fontsize}{extarticle}
...
\title{Titre du document(default value)} % Title of the document; 
\maketitle{Titre du document(default value)} % 
% \thispagestyle{empty} % Remove the page number from the title page
